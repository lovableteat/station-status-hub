      ...
      <div className="grid gap-5 xl:grid-cols-[0.96fr_1.04fr]">
        ...
        <Card className="border-cyan-300/18 bg-[#17253d] shadow-[0_24px_60px_rgba(2,8,23,0.22)]">
          ...
          <CardContent className="space-y-5 pt-5">
            ...
            <Separator className="bg-cyan-300/10" />

            <div className="grid gap-4 xl:grid-cols-2">
              <div className="space-y-2">
                <p className="text-sm font-black text-slate-200">curl 範例</p>
                <ScrollArea className="h-[180px] rounded-2xl border border-cyan-300/14 bg-[#0d1729] px-4 py-3">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[260px] border-cyan-300/18 bg-[#0d1729] font-mono text-sm leading-7 text-slate-100 placeholder:text-slate-400"
              />
            </div>
          </CardContent>
        </Card>
