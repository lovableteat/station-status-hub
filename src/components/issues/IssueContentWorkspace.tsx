...
const editorClassName = "min-h-[300px] border-[#315b78] bg-[#071522]";
...
export function IssueContentWorkspace({
  ...
  return (
    <section data-ui="issue-content-workspace" className="min-w-0">
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-[#294c66] px-1 pb-3">
        <div className="flex items-start gap-3">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-amber-300/12 text-amber-100">
      ...
      <Tabs defaultValue="description" className="pt-3">
        <TabsList className="grid h-auto w-full grid-cols-3 gap-1 border-b border-[#294c66] bg-transparent p-0">
          <TabsTrigger value="description" className="min-h-11 gap-2 rounded-none border-b-2 border-transparent bg-transparent text-[#9fb6c7] shadow-none data-[state=active]:border-amber-300 data-[state=active]:bg-amber-300/[0.07] data-[state=active]:text-amber-50 data-[state=active]:shadow-none">
            <AlertTriangle className="h-3.5 w-3.5" />問題描述 <span className="text-amber-200">*</span>
          </TabsTrigger>
          <TabsTrigger value="process" className="min-h-11 gap-2 rounded-none border-b-2 border-transparent bg-transparent text-[#9fb6c7] shadow-none data-[state=active]:border-cyan-300 data-[state=active]:bg-cyan-300/[0.07] data-[state=active]:text-cyan-50 data-[state=active]:shadow-none">
            <ClipboardPenLine className="h-3.5 w-3.5" />處理過程
          </TabsTrigger>
          <TabsTrigger value="solution" className="min-h-11 gap-2 rounded-none border-b-2 border-transparent bg-transparent text-[#9fb6c7] shadow-none data-[state=active]:border-emerald-300 data-[state=active]:bg-emerald-300/[0.07] data-[state=active]:text-emerald-50 data-[state=active]:shadow-none">
