...
export const BUILT_IN_RACK_MODELS: Record<string, RackModelDefinition> = {
  ...
  "generic-gpu-server-2u": {
    id: "generic-gpu-server-2u",
    kind: "l10",
    manufacturer: "Open Compute",
    name: "GPU 運算伺服器 2U",
    revision: "Reference",
    source: "procedural",
    dimensions: { widthMm: 482.6, depthMm: 850, heightMm: 88.9 },
    upAxis: "y",
    rackUnits: 2,
    equipmentCategory: "compute",
    isCalibrated: true,
  },
  "generic-tor-switch-1u": {
    id: "generic-tor-switch-1u",
    kind: "l10",
    manufacturer: "Open Network",
    name: "ToR 網路交換器 1U",
    revision: "Reference",
    source: "procedural",
    dimensions: { widthMm: 482.6, depthMm: 520, heightMm: 44.45 },
    upAxis: "y",
    rackUnits: 1,
    equipmentCategory: "network",
    isCalibrated: true,
  },
  "generic-storage-array-2u": {
    id: "generic-storage-array-2u",
    kind: "l10",
    manufacturer: "Open Storage",
    name: "NVMe 儲存陣列 2U",
    revision: "Reference",
    source: "procedural",
    dimensions: { widthMm: 482.6, depthMm: 780, heightMm: 88.9 },
    upAxis: "y",
    rackUnits: 2,
    equipmentCategory: "storage",
    isCalibrated: true,
  },
  "generic-power-shelf-3u": {
    id: "generic-power-shelf-3u",
    kind: "l10",
    manufacturer: "Open Power",
    name: "電源模組 3U",
    revision: "Reference",
    source: "procedural",
    dimensions: { widthMm: 482.6, depthMm: 650, heightMm: 133.35 },
    upAxis: "y",
    rackUnits: 3,
    equipmentCategory: "power",
    isCalibrated: true,
  },
  "generic-cooling-controller-1u": {
    id: "generic-cooling-controller-1u",
    kind: "l10",
    manufacturer: "Open Cooling",
    name: "冷卻控制器 1U",
    revision: "Reference",
    source: "procedural",
    dimensions: { widthMm: 482.6, depthMm: 420, heightMm: 44.45 },
    upAxis: "y",
    rackUnits: 1,
