...
function BoardInspector({ workspace }: { workspace: PcbWorkspaceApi }) {
  ...
  return (
    <div className="pcb-inspector-form">
      ...
      <Button type="button" size="sm" disabled={disabled} onClick={() => setDrawing(true)}>編輯外框／挖孔</Button>
      ...
      <details className="mt-2" aria-label="板框尺寸增減方向">
      ...
      <details className="mt-3"><summary className="cursor-pointer text-sm">從 DXF 匯入板形（取代目前外框）</summary><div className="pcb-dxf-import">
      ...
      <section className="pcb-inspector-section">
      <h3 className="text-emerald-200">顯示與吸附</h3>
      ...
      <div className="pcb-inspector-section" data-testid="pcb-board-cuts">
        ...
        <p className="pcb-inspector-note">只標示等分位置，不會切除板材。要改外形或挖洞，請使用「編輯外框／挖孔」。</p>
        <div className="pcb-inspector-field-grid">
