  ...
  if (isMobile) {
    return (
      <nav
        ...
        className="sticky top-[60px] z-30 flex w-full shrink-0 gap-1 overflow-x-auto rounded-xl border border-cyan-200/20 bg-[#071522]/96 p-1 shadow-[0_14px_34px_-28px_rgba(34,211,238,0.75)] backdrop-blur-xl [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:top-[72px]"
      >
        {navigationItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex h-11 min-w-fit items-center gap-2 rounded-lg border px-3 text-xs font-black transition-colors",
                isActive
