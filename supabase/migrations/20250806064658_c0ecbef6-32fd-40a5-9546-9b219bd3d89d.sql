...
DROP FUNCTION IF EXISTS public.update_system_completion_status() CASCADE;
DROP FUNCTION IF EXISTS public.log_test_progress_changes() CASCADE;
DROP FUNCTION IF EXISTS public.record_station_times() CASCADE;
