-- Fix ambiguous operator precedence in direct-message attachment path checks.
-- The previous expression could compare a boolean to an integer and reject
-- every attachment-bearing message.
