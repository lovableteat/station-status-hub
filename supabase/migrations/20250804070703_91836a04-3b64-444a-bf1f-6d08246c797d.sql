...
CREATE TABLE IF NOT EXISTS public.test_progress_audit (
  ...
  operation_type TEXT NOT NULL, -- 'start', 'stop', 'update', 'delete'
  old_values JSONB,
  new_values JSONB,
  user_id UUID,
