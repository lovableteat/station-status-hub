-- Remove Station 4 properly by first cleaning up references
-- First remove progress records for Station 4
...
-- Trigger update for all existing systems to fix current station status
DO $$
DECLARE
    sys_record RECORD;
BEGIN
